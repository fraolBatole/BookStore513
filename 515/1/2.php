...
<form method="POST" action="crawler.php">
  <div class="form-row">
        <div class="form-group col-md-12">
            Seed URL :
            <input class="form-control" type="text" name="URL" placeholder="Input URL...">
        </div> <!-- form-group// -->      
        <div class="form-group col-md-8">
            Max Page Limit (500) :
            <input class="form-control" type="number" max="500" name="pageLimit" placeholder="Input Max page limit" required>
        </div> <!-- form-group// -->     
        <div class="form-group col-md-8">
